...
public class DbConnectivityClass {
    ...
    final static String SQL_SERVER_URL = "jdbc:mysql://francois-server.mysql.database.azure.com";//update this server name
    final static String DB_URL = SQL_SERVER_URL + "/" + DB_NAME;//update this database name
    final static String USERNAME = "kfrancois";// update this username
    final static String PASSWORD = "farmingdale#1030";// update this password


        private final ObservableList<Person> data = FXCollections.observableArrayList();

        // Method to retrieve all data from the database and store it into an observable list to use in the GUI tableview.w
